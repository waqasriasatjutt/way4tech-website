...
export const SERVICES = [
  ...
  { slug: 'hire-odoo-developer', title: 'Hire Odoo Developer', tagline: 'Dedicated developers by the week or month.', icon: '👨‍💻', category: 'Talent',
    ...
    details: ['Senior Python + OWL developers','Functional consultants with 5+ years','Part-time, full-time, or sprint-based','Daily stand-ups and weekly reports','Direct Slack/WhatsApp access','NDA-protected engagements','Working-hour overlap with your timezone','Replacement guarantee within 7 days'] },
  ...
  { slug: 'odoo-audit', title: 'Odoo Health Audit', tagline: 'Deep technical + functional audit of your instance.', icon: '🔍', category: 'Strategy',
    short: 'A 2-week audit covering code quality, database health, security, workflow efficiency, and license compliance, with a 50-page written report.',
  ...
  { slug: 'odoo-payroll-setup', title: 'Payroll Setup', tagline: 'Country-specific payroll configuration.', icon: '💰', category: 'HR',
    short: 'Design and configure payroll rule books for any country: tax slabs, social security, overtime, and allowances, with an audit trail from rule to payslip line.',
  ...
  { slug: 'odoo-pos-deployment', title: 'POS Deployment', tagline: 'Retail / F&B / salon / clinic POS end-to-end.', icon: '🛒', category: 'Retail',
    short: 'Industry-specific POS rollout for retail, restaurant, salon, clinic, and car wash, with hardware integration (scanner, scale, printer, IoT box) and offline mode.',
...
export const MODULES = [
  { slug: 'studio', title: 'Odoo Studio', icon: '🧰', category: 'Productivity', tagline: 'Build fields, views, reports and automations without code.', short: 'Odoo Studio is the no-code builder inside Odoo Enterprise. Add fields, redesign views, edit PDF reports and wire automations from the browser. It covers a lot, and knowing where it stops and real development starts is the difference between a fast project and an expensive one.', features: ['Add fields and change views in the browser','PDF report designer','Automation rules without Python','Approval steps on any model','Where Studio stops and a module starts','Keeping Studio changes upgrade-safe'] },
  { slug: 'iot', title: 'Odoo IoT', icon: '📡', category: 'Operations', tagline: 'Scales, printers, scanners and payment terminals on the shop floor.', short: 'The Odoo IoT box connects physical hardware to Odoo: weighing scales, receipt and label printers, barcode scanners, measurement tools and payment terminals. Most of the work in an IoT project is device compatibility, not Odoo.', features: ['IoT box setup and network','Scales and measurement tools in MRP and PoS','Label and receipt printers','Barcode scanner pairing','Payment terminal integration','What hardware is actually supported'] },
  { slug: 'field-service', title: 'Odoo Field Service', icon: '🚚', category: 'Operations', tagline: 'Scheduling, on-site tasks, timesheets and invoicing from the field.', short: 'Odoo Field Service plans and dispatches on-site work, tracks time and parts used, captures a signature on site, and turns the visit into an invoice. It sits on Project and Timesheets, so how those are configured decides how well it runs.', features: ['Task scheduling and dispatch','Mobile worksheets on site','Time and parts consumed per visit','Customer signature capture','Invoice from the worksheet','Recurring maintenance visits'] },
  { slug: 'rental', title: 'Odoo Rental', icon: '📅', category: 'Sales', tagline: 'Rental orders, availability, pickup and return, late fees.', short: 'Odoo Rental handles hire businesses: what is out, what is available, when it comes back and what to charge when it does not. Availability across overlapping bookings is where most rental implementations get difficult.', features: ['Rental pricing by hour, day or week','Availability across overlapping bookings','Pickup and return workflow','Late fees and damage charges','Serial-number tracked assets','Rental plus sale on one order'] },
  { slug: 'planning', title: 'Odoo Planning', icon: '🗓', category: 'HR', tagline: 'Shift planning, role coverage and publishing rosters to staff.', short: 'Odoo Planning builds shift rosters by role and publishes them to staff. It matters most where cover is a legal or contractual requirement rather than a preference.', features: ['Shifts by role and skill','Publish and notify staff','Open shifts staff can take','Cover gaps visible before the week starts','Planning against sales forecast','Timesheet reconciliation'] },
  { slug: 'elearning', title: 'Odoo eLearning', icon: '🎓', category: 'Marketing', tagline: 'Courses, quizzes, certification and student progress.', short: 'Odoo eLearning publishes courses with video, quizzes and certification, either free or paid through eCommerce. Common uses are customer onboarding, partner enablement and internal training records.', features: ['Course and lesson structure','Quizzes and certification','Paid courses through eCommerce','Progress and completion tracking','Certificates on completion','Forum and Q and A per course'] },
  { slug: 'events', title: 'Odoo Events', icon: '🎟', category: 'Marketing', tagline: 'Registration, ticketing, tracks and on-site check-in.', short: 'Odoo Events runs registration and ticketing, publishes the agenda to the website, takes payment and handles check-in on the day with a barcode scan.', features: ['Ticket types and pricing','Registration pages on the website','Payment at registration','Barcode check-in on the day','Speaker and track management','Follow-up email automation'] },
  { slug: 'fleet', title: 'Odoo Fleet', icon: '🚗', category: 'Operations', tagline: 'Vehicles, contracts, fuel, services and driver assignment.', short: 'Odoo Fleet tracks vehicles, who drives them, what they cost and when they are due for service. Odometer-driven service scheduling is the part that pays for itself.', features: ['Vehicle records and documents','Driver assignment history','Fuel and cost logging','Service scheduling by odometer or date','Lease and insurance contract renewals','Total cost per vehicle'] },
  { slug: 'barcode', title: 'Odoo Barcode', icon: '📪', category: 'Inventory', tagline: 'Scan-driven receipts, transfers, picking and inventory counts.', short: 'Odoo Barcode turns warehouse operations into scanning: receipts, internal transfers, picking, packing and stock counts. It needs a barcode strategy on products and locations first, which is where most of the setup effort goes.', features: ['Receipts and putaway by scan','Wave and batch picking','Pack and ship confirmation','Cycle counts and inventory adjustments','Lot and serial capture at scan','Barcode nomenclature setup'] },
  { slug: 'repairs', title: 'Odoo Repairs', icon: '🔧', category: 'Operations', tagline: 'Repair orders, parts consumed, warranty and re-invoicing.', short: 'Odoo Repairs manages items in for repair: what came in, what was used, what is under warranty and what gets invoiced. It links to stock, so parts consumed move correctly.', features: ['Repair order from a sale or RMA','Parts consumed against stock','Warranty versus chargeable','Quotation before repair','Return to customer workflow','Repair history per serial number'] },
  { slug: 'subscriptions', title: 'Odoo Subscriptions', icon: '🔁', category: 'Sales', tagline: 'Recurring plans, renewals, upsell and churn reporting.', short: 'Odoo Subscriptions runs recurring revenue: plans, automatic invoicing, renewals, upgrades and the reporting that tells you what is churning. Revenue recognition is the accounting side worth agreeing early.', features: ['Recurring plans and pricing','Automatic invoicing and payment','Upsell and downgrade mid-term','Renewal and churn reporting','Customer self-service portal','Deferred revenue posting'] },
  { slug: 'expenses', title: 'Odoo Expenses', icon: '💳', category: 'HR', tagline: 'Employee expense claims, approval and reimbursement.', short: 'Odoo Expenses captures claims from a phone, routes them for approval and posts the accounting entry. Reimbursement through payroll or as a supplier payment is a configuration decision, not a limitation.', features: ['Submit from mobile with a photo','Multi-step approval','Company card versus employee paid','Post to accounting automatically','Reimburse via payroll or payment','Re-invoice expenses to a customer'] },
  { slug: 'appointments', title: 'Odoo Appointments', icon: '📆', category: 'Sales', tagline: 'Online booking against real staff availability.', short: 'Odoo Appointments publishes bookable slots on the website, checks real calendar availability and creates the meeting. It is the front door for services businesses that currently book by phone.', features: ['Bookable slots by staff and resource','Availability from real calendars','Payment at booking','Reminders and rescheduling','Multiple appointment types','Booking pages per team'] },
  { slug: 'live-chat', title: 'Odoo Live Chat', icon: '💬', category: 'Marketing', tagline: 'Website chat, canned responses and lead capture.', short: 'Odoo Live Chat puts a chat window on the website, routes conversations to the right team and turns a conversation into a lead or a helpdesk ticket without retyping anything.', features: ['Chat routing by page and team','Canned responses','Convert a chat to a lead or ticket','Chatbot for out-of-hours','Visitor history and context','Rating after the conversation'] },
  { slug: 'sales', title: 'Odoo Sales', icon: '📈', category: 'Sales', tagline: 'Quotes, orders, pricelists, subscriptions.', short: 'Speed up the quote-to-order process with templates, pricelists, discounts, electronic signatures, and order confirmation workflows.', features: ['Configurable quote templates','Customer-specific pricelists','Upsell, cross-sell, subscription','Electronic signature on quote','Commission tracking','Real-time margin analysis'] },
  ...
  { slug: 'accounting', title: 'Odoo Accounting', icon: '💼', category: 'Finance', tagline: 'Odoo Invoicing and accounting: ledger, AR/AP, tax, e-invoicing.', short: 'Full double-entry accounting with multi-currency, automated reconciliation, tax localization, e-invoicing, and IFRS/GAAP-ready reports.', features: ['Multi-company, multi-currency','Automated bank reconciliation','Tax localization (50+ countries)','E-invoicing (ZATCA, PEPPOL, SDI)','Fixed assets & depreciation','IFRS/GAAP reports'] },
  { slug: 'hr', title: 'Odoo HR', icon: '👥', category: 'HR', tagline: 'Odoo HRMS: employees, contracts, departments, onboarding.', short: 'Central employee directory with contracts, departments, org chart, skills, documents, and full onboarding/offboarding workflows.', features: ['Employee master data','Org chart & departments','Contracts & grade mapping','Onboarding & offboarding checklists','Skills & certifications','Document vault'] },
  ...
  { slug: 'manufacturing', title: 'Odoo Manufacturing (MRP)', icon: '🏭', category: 'Operations', tagline: 'Odoo MRP: BOMs, work orders, routings, quality.', short: 'Full MRP: BOMs, routings, work orders, MRP planning, shop floor terminals, and quality checkpoints.', features: ['Multi-level BOMs','Work centers & routings','MRP planning & procurement','Shop floor terminal','Quality control points','Maintenance integration'] },
  ...
  { slug: 'knowledge', title: 'Odoo Knowledge', icon: '📚', category: 'Services', tagline: 'Wiki + procedures + runbooks.', short: 'Internal wiki with rich articles, property-based structured data, template library, and full-text search: the single source of truth for your team.', features: ['Rich article editor','Property-based data','Template library','Full-text search','Favorites & sharing','Versioning & history'] },
];
...
export const SOLUTIONS = [
  ...
  { slug: 'gym-fitness', title: 'Gym & Fitness Clubs', icon: '🏋️', tagline: 'Memberships, classes, trainers, door access.', short: 'Health club ERP: recurring membership billing, contract freeze, door access check-in, class timetable with waitlist, personal training packages, and churn reporting.', features: ['Membership plans & recurring billing','Contract freeze & transfer','Door access check-in','Class timetable & waitlist','Personal training packages','Trainer commission','Body measurement tracking','Retention & churn analysis'] },
  { slug: 'veterinary-clinic', title: 'Veterinary Clinics', icon: '🐾', tagline: 'Patients, consultations, vaccinations, pharmacy.', short: 'Veterinary practice ERP: patient records by species and breed, SOAP consultation notes, vaccination recalls, prescriptions with withdrawal periods, lab requests, surgery, boarding and grooming.', features: ['Patient records by species & breed','SOAP consultation notes','Vaccination schedule & recalls','Prescriptions & drug withdrawal','Lab requests & results','Surgery scheduling','Boarding & grooming','Pet insurance claims'] },
  { slug: 'laundry-dry-cleaning', title: 'Laundry & Dry Cleaning', icon: '🧺', tagline: 'Piece tagging, plant stages, routes, contracts.', short: 'Laundry and dry cleaning ERP: a barcode tag per garment, plant stages from sorting to packing, express surcharges, collection routes, hotel contract rates, and damage claims.', features: ['Garment tagging & barcodes','Plant stages through to packing','Rack & slot locations','Per-piece, per-kilo, per-metre pricing','Express & same-day surcharge','Pickup & delivery routes','Hotel & corporate contract rates','Damage & loss claims'] },
  { slug: 'jewellery-retail', title: 'Jewellery Retail', icon: '💍', tagline: 'Metal rate, making charge, buy-back, hallmark.', short: 'Jewellery retail ERP: dated metal rate per gram and purity, counter pricing from the rate plus making and wastage, old-gold buy-back, repair job cards, hallmark register, and stock by weight.', features: ['Dated metal rate per gram','Purity & wastage handling','Counter pricing off the rate','Old-gold buy-back with purity test','Repair & custom order job cards','Hallmark & purity register','Stone certificates','Approval memo issue & reconciliation'] },
  { slug: 'legal-practice', title: 'Legal Practice', icon: '⚖️', tagline: 'Matters, time recording, client money, bills.', short: 'Law firm management: conflict checks before a matter opens, limitation diary, time recording against a rate card, disbursements kept apart from fees, a segregated client account, and WIP reporting.', features: ['Conflict of interest checks','Matter file & limitation diary','Time recording on a rate card','Write-offs & write-downs','Disbursements kept off fees','Segregated client account','Bills of costs','WIP, realization & lock-up'] },
  { slug: 'printing-press', title: 'Printing Press', icon: '🖨️', tagline: 'Estimating, imposition, job tickets, spoilage.', short: 'Commercial print ERP: sheet imposition inside the estimate, litho and digital costing with plates, ink and make-ready split out, job tickets from prepress to dispatch, and reprint reasons.', features: ['Imposition & sheet calculation','Litho & digital estimating','Plates, ink & make-ready costed apart','Job ticket through to dispatch','Customer proof approval','Spoilage & reprint reasons','Quantity tolerance invoicing','Job cost against estimate'] },
  { slug: 'solar-epc', title: 'Solar EPC', icon: '☀️', tagline: 'Design, BOM, milestone billing, O&M.', short: 'Solar EPC and O&M: site surveys, string sizing and payback in the design, bill of materials off that design, milestone billing, grid connection paperwork, commissioning readings, and a warranty register.', features: ['Site survey & shading notes','String sizing & payback','Design straight to bill of materials','Milestone billing','Grid connection applications','Commissioning readings','Warranty register','Generation monitoring'] },
  { slug: 'travel-agency', title: 'Travel Agencies & Tour Operators', icon: '✈️', tagline: 'Booking files, itineraries, markup, departures.', short: 'Retail travel and tour operator ERP: booking files with PNR, passport and visa tracking, flight, hotel, transfer and cruise segments with cost and sell, fixed departures with seat inventory, and amendment fees.', features: ['Booking file with PNR','Passport & visa tracking','Flight, hotel, transfer, cruise segments','Supplier cost against sell price','Markup & commission','Fixed departures & seat inventory','Amendment & cancellation fees','Deposit & balance plans'] },
  { slug: 'insurance-brokerage', title: 'Insurance Brokerage', icon: '🛡️', tagline: 'Quotes, policies, renewals, claims, commission.', short: 'Broker and agency system: insurer commission terms, side-by-side market quotes, policies with installments, mid-term endorsements pro-rated over the remaining term, a renewal pipeline, and claims with reserves.', features: ['Market quotes side by side','Insurer commission terms','Policy with installment plan','Mid-term endorsements pro-rated','Renewal pipeline & retention','Claims with reserves','Adjuster assignment','Commission expected against received'] },
  { slug: 'coworking-space', title: 'Coworking Spaces', icon: '🪑', tagline: 'Desks, offices, meeting rooms, memberships.', short: 'Coworking and serviced office ERP: hot desks, dedicated desks, private offices and meeting rooms with a clash check, membership plans with room credits, company accounts, and one monthly invoice per account.', features: ['Hot desk, dedicated desk, private office','Meeting rooms with clash check','Membership plans & room credits','Company accounts & seat allocation','Day passes','Check-in, check-out, live occupancy','Registered address & mail handling','One monthly invoice per account'] },
  { slug: 'fuel-station', title: 'Fuel Stations & Forecourts', icon: '⛽', tagline: 'Tanks, dips, shift reconciliation, wet stock.', short: 'Forecourt ERP: underground tank dips, pump and nozzle meter readings, shift reconciliation to cash over or short, tanker deliveries with temperature correction, wet stock variance, and shop stock.', features: ['Tank dips & stock in the ground','Pump & nozzle meter readings','Shift reconciliation, over or short','Tanker deliveries & density','Wet stock variance','Pump price changes','Fleet credit accounts','Forecourt shop stock'] },
  { slug: 'freight-forwarding', title: 'Freight Forwarding', icon: '🚢', tagline: 'Job files, bills, charges, customs, lane margin.', short: 'Freight forwarding and customs broking: air, sea FCL, sea LCL and road job files, master and house bills, containers with VGM, chargeable weight, cost and sell on every charge, and gross profit by lane.', features: ['Air, sea FCL, sea LCL, road job files','Master & house bills','Containers & VGM','Chargeable weight calculation','Cost and sell per charge line','Agent profit share','Customs entry & duty capture','Gross profit by lane & salesperson'] },
  { slug: 'equipment-rental', title: 'Equipment Rental', icon: '🚜', tagline: 'Fleet, rate cards, off-hire, damage, utilization.', short: 'Plant, tool and machinery hire: a unit-level fleet with hour and kilometre meters, rate cards where the cheapest rate wins, availability across a date range, off-hire with meter overuse, and damage against hand-over condition.', features: ['Unit-level fleet register','Hour & kilometre meters','Rate cards, cheapest rate wins','Availability across a date range','Off-hire & meter overuse','Damage against hand-over condition','Deposits & late return penalties','Inspection certificates & utilization'] },
  { slug: 'car-wash', title: 'Car Wash & Detailing', icon: '🚿', tagline: 'Bookings, packages, bays, staff commission.', short: 'Car wash operations: portal and counter bookings, wash and detailing packages, bay allocation, staff scheduling, commission per washer, thermal receipts, and invoicing off the finished job.', features: ['Portal & counter booking','Wash & detailing packages','Service bay allocation','Staff scheduling & roster','Multi-stage job workflow','Staff commission','Thermal receipt printing','Invoicing from the finished job'] },
  { slug: 'event-management', title: 'Event & Wedding Planning', icon: '🎪', tagline: 'Venues, packages, suppliers, run sheets, budget.', short: 'Event and wedding planning ERP: a venue diary that refuses a double booking, packages priced per head or flat, supplier quotes with insurance and license checks, timed run sheets, guest list with RSVP, and budget variance.', features: ['Venue diary, double booking refused','Per-head or flat packages','Supplier quotes & documents','Insurance & license checks','Timed run sheets','Staffing roster','Guest list, RSVP & seating','Budget variance & payment milestones'] },
  { slug: 'facility-management', title: 'Facility Management', icon: '🧰', tagline: 'Asset register, PPM, work orders, SLA clocks.', short: 'CAFM for hard services: site, building, floor and space register, asset hierarchy with warranty and criticality, planned maintenance on interval or meter, reactive work orders with response and resolution clocks, and permit to work.', features: ['Site, building, floor & space register','Asset hierarchy & criticality','Planned maintenance on interval or meter','Reactive work orders','Response & resolution clocks','Permit to work','Spares issued off stock','Lifetime cost per asset'] },
  { slug: 'water-delivery', title: 'Bottled Water Delivery', icon: '💧', tagline: 'Containers, coupons, rounds, dispenser rental.', short: 'Bottled water plant and home delivery: a returnable container ledger with deposits, coupon books and subscriptions, daily rounds with load-out and reconciliation, dispenser rentals, and a quality test log per batch.', features: ['Returnable container ledger','Deposits held per container','Coupon books & subscriptions','Rounds with load-out','Driver reconciliation at day end','Delivery confirmed at the door','Dispenser & cooler rentals','Water quality test log per batch'] },
];
...
export const COUNTRIES = [
  { slug: 'saudi-arabia', title: 'Saudi Arabia (KSA)', flag: '🇸🇦', currency: 'SAR', lang: 'ar-SA', abbr: 'KSA', cities: ['Riyadh','Jeddah','Dammam','Khobar','Makkah','Madinah','Jubail','Tabuk'],
  ...
  { slug: 'uae', title: 'United Arab Emirates', flag: '🇦🇪', currency: 'AED', lang: 'en-AE', abbr: 'UAE', cities: ['Dubai','Abu Dhabi','Sharjah','Ajman','Ras Al Khaimah','Al Ain','Fujairah'],
  ...
  { slug: 'qatar', title: 'Qatar', flag: '🇶🇦', currency: 'QAR', lang: 'en-QA', cities: ['Doha','Al Rayyan','Lusail','Al Wakrah'],
  ...
  { slug: 'kuwait', title: 'Kuwait', flag: '🇰🇼', currency: 'KWD', lang: 'en-KW', cities: ['Kuwait City','Hawalli','Al Ahmadi','Farwaniya','Salmiya'],
  ...
  { slug: 'oman', title: 'Oman', flag: '🇴🇲', currency: 'OMR', lang: 'en-OM', cities: ['Muscat','Salalah','Sohar','Nizwa','Sur'],
  ...
  { slug: 'bahrain', title: 'Bahrain', flag: '🇧🇭', currency: 'BHD', lang: 'en-BH', cities: ['Manama','Muharraq','Riffa','Isa Town'],
  ...
  { slug: 'pakistan', title: 'Pakistan', flag: '🇵🇰', currency: 'PKR', lang: 'en-PK', cities: ['Karachi','Lahore','Islamabad','Rawalpindi','Faisalabad','Multan','Peshawar','Sialkot'],
    regions: ['Punjab','Sindh','Khyber Pakhtunkhwa'],
  ...
  { slug: 'india', title: 'India', flag: '🇮🇳', currency: 'INR', lang: 'en-IN', cities: ['Mumbai','Delhi','Bangalore','Hyderabad','Chennai','Pune','Ahmedabad','Kolkata'],
    regions: ['Maharashtra','Karnataka','Telangana','Tamil Nadu','Gujarat','West Bengal'],
  ...
  { slug: 'bangladesh', title: 'Bangladesh', flag: '🇧🇩', currency: 'BDT', lang: 'en-BD', cities: ['Dhaka','Chattogram','Sylhet','Gazipur','Narayanganj','Khulna'],
  ...
  { slug: 'egypt', title: 'Egypt', flag: '🇪🇬', currency: 'EGP', lang: 'ar-EG', cities: ['Cairo','Alexandria','Giza','New Cairo','6th of October City','Mansoura'],
  ...
  { slug: 'jordan', title: 'Jordan', flag: '🇯🇴', currency: 'JOD', lang: 'ar-JO', cities: ['Amman','Zarqa','Irbid','Aqaba'],
  ...
  { slug: 'turkey', title: 'Turkey', flag: '🇹🇷', currency: 'TRY', lang: 'tr-TR', cities: ['Istanbul','Ankara','Izmir','Bursa','Antalya','Konya','Gaziantep'],
  ...
  { slug: 'united-kingdom', title: 'United Kingdom', flag: '🇬🇧', currency: 'GBP', lang: 'en-GB', abbr: 'UK', cities: ['London','Manchester','Birmingham','Leeds','Glasgow','Edinburgh','Bristol','Liverpool'],
  ...
  { slug: 'germany', title: 'Germany', flag: '🇩🇪', currency: 'EUR', lang: 'de-DE', cities: ['Berlin','Munich','Frankfurt','Hamburg','Cologne','Stuttgart','Düsseldorf'],
    regions: ['Bavaria','North Rhine-Westphalia','Baden-Württemberg','Hesse'],
  ...
  { slug: 'france', title: 'France', flag: '🇫🇷', currency: 'EUR', lang: 'fr-FR', cities: ['Paris','Lyon','Marseille','Toulouse','Lille','Bordeaux','Nantes'],
    regions: ['Île-de-France','Auvergne-Rhône-Alpes','Occitanie','Hauts-de-France'],
  ...
  { slug: 'united-states', title: 'United States', flag: '🇺🇸', currency: 'USD', lang: 'en-US', abbr: 'USA', cities: ['New York','Los Angeles','Chicago','Houston','Miami','Dallas','Atlanta','San Francisco','Seattle'],
    regions: ['California','Texas','New York','Florida','Illinois','Georgia','Washington'],
  ...
  { slug: 'canada', title: 'Canada', flag: '🇨🇦', currency: 'CAD', lang: 'en-CA', cities: ['Toronto','Vancouver','Montreal','Calgary','Ottawa','Edmonton'],
  ...
  { slug: 'australia', title: 'Australia', flag: '🇦🇺', currency: 'AUD', lang: 'en-AU', cities: ['Sydney','Melbourne','Brisbane','Perth','Adelaide','Gold Coast'],
...
export const PRODUCTS = [
  ...
  { slug: 'odoo-barcode-scanner', title: 'Offline Barcode Scanner', category: 'Specialty', tagline: 'Full-screen barcode scanner with offline cache.', short: 'Standalone barcode scanner app that loads products into IndexedDB for fully offline price checking. Works without internet.' },
...
export const INDUSTRIES = [
  ...
  { slug: 'gym-fitness', title: 'Gyms & Fitness', icon: '🏋️', description: 'Member data, billing dates, door hardware, class schedule: what a club settles before go-live.' },
  { slug: 'veterinary-clinic', title: 'Veterinary', icon: '🐾', description: 'Patient history, vaccination recalls, drug stock and insurance, in the order a practice loads them.' },
  { slug: 'laundry-dry-cleaning', title: 'Laundry', icon: '🧺', description: 'Tagging, plant stages and collection routes: the setup a laundry needs before the first ticket.' },
  { slug: 'jewellery-retail', title: 'Jewellery', icon: '💍', description: 'Weight, purity and the daily rate: how a jeweller moves stock and counter pricing onto Odoo.' },
  { slug: 'legal-practice', title: 'Legal', icon: '⚖️', description: 'Matters, time capture and client money: what a firm decides before an Odoo go-live.' },
  { slug: 'printing-press', title: 'Printing', icon: '🖨️', description: 'Estimating rules, machine rates and job tickets: sequencing a rollout in a print shop.' },
  { slug: 'solar-epc', title: 'Solar EPC', icon: '☀️', description: 'Design, procurement and site work on one system: how an EPC contractor phases the rollout.' },
  { slug: 'travel-agency', title: 'Travel', icon: '✈️', description: 'Booking files, supplier costs and departures: moving an agency off spreadsheets.' },
  { slug: 'insurance-brokerage', title: 'Insurance', icon: '🛡️', description: 'Policies, renewals and commission reconciliation: what a brokerage prepares first.' },
  { slug: 'coworking-space', title: 'Coworking', icon: '🪑', description: 'Desks, rooms and monthly billing: setting up a rollout for a flexible workspace.' },
  { slug: 'fuel-station', title: 'Fuel Stations', icon: '⛽', description: 'Tanks, pumps and shift handover: what a forecourt puts in place before Odoo takes readings.' },
  { slug: 'freight-forwarding', title: 'Freight Forwarding', icon: '🚢', description: 'Job files, charge codes and agent accounts: phasing Odoo into a forwarding office.' },
  { slug: 'equipment-rental', title: 'Equipment Rental', icon: '🚜', description: 'Fleet register, rate cards and meter readings: how a hire company gets running on Odoo.' },
  { slug: 'car-wash', title: 'Car Wash', icon: '🚿', description: 'Bays, packages and commission rules: a short rollout for one site or a small chain.' },
  { slug: 'event-management', title: 'Events', icon: '🎪', description: 'Venues, suppliers and run sheets: how an events firm phases Odoo across a season.' },
  { slug: 'facility-management', title: 'Facilities', icon: '🧰', description: 'Asset register first, then planned maintenance and work orders: the order a CAFM rollout runs in.' },
  { slug: 'water-delivery', title: 'Water Delivery', icon: '💧', description: 'Containers, coupons and rounds: what a water plant sets up before the first delivery run.' },
];
