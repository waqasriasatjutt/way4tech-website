...
export const COUNTRIES = [
  { slug: 'saudi-arabia', title: 'Saudi Arabia (KSA)', flag: '🇸🇦', currency: 'SAR', lang: 'ar-SA', abbr: 'KSA', cities: ['Riyadh','Jeddah','Dammam','Khobar','Makkah','Madinah'],
  ...
  { slug: 'uae', title: 'United Arab Emirates', flag: '🇦🇪', currency: 'AED', lang: 'en-AE', abbr: 'UAE', cities: ['Dubai','Abu Dhabi','Sharjah','Ajman','Ras Al Khaimah'],
  ...
  { slug: 'india', title: 'India', flag: '🇮🇳', currency: 'INR', lang: 'en-IN', cities: ['Mumbai','Delhi','Bangalore','Hyderabad','Chennai','Pune'],
    regions: ['Maharashtra','Karnataka','Telangana','Tamil Nadu','Gujarat'],
  ...
  { slug: 'united-kingdom', title: 'United Kingdom', flag: '🇬🇧', currency: 'GBP', lang: 'en-GB', abbr: 'UK', cities: ['London','Manchester','Birmingham'],
  ...
  { slug: 'united-states', title: 'United States', flag: '🇺🇸', currency: 'USD', lang: 'en-US', abbr: 'USA', cities: ['New York','Los Angeles','Chicago','Houston','Miami'],
